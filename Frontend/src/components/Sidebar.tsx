...
// iconos SVG internos sin dependencias extra
const IconMarket = () => (
...
interface SidebarProps {
  open: boolean           // controlado por DashboardLayout
  onClose: () => void     // para cerrar desde el overlay o el botón X
}
...
function Sidebar({ open, onClose }: SidebarProps) {
  ...
  // cuando el usuario hace click en un link en mobile, cerramos el sidebar
